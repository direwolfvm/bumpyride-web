  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <p className="mt-2 max-w-3xl text-text-muted">
        ...
        opted in to public sharing — mounted-sensor data only. Pocket-mode
        rides are excluded so the readings here aren&apos;t damped by
        ...
        Map&apos;s default filter). Cells are 20 ft squares; we only show a
